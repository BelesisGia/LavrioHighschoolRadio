		...
		<div class="container">
			...
			<div id="about" class="scrollspy">
				...
				<p class="flow-text line-height">
					Το Γενικό Λύκειο Λαυρίου αποκτά το δικό του διαδικτυακό μαθητικό ραδιόφωνο. Ακούστε καθημερινά από τις 8:30 το πρωί μέχρι τις 13:00 με ζωντανές εκπομπές και μουσική για όλη την υπόλοιπη ημέρα. Το Γενικό Λύκειο Λαυρίου , με την τωρινή του μορφή, ιδρύθηκε το 1976 και αρχικά συστεγαζόταν με το Γυμνάσιο Λαυρίου. Εντούτοις η ιστορική του διαδρομή ξεκινά το 1923-24 με την ίδρυση στο Λαύριο του Πρακτικού Λυκείου Λαυρίου. Βρίσκεται στην οδό Α. Κορδέλα 4, μέσα στην πόλη του Λαυρίου και στεγάζεται σε ένα τριώροφο κτήριο που κατασκευάσθηκε το 1987, μέσα σε περιφραγμένο χώρο 12 στρεμμάτων.
				</p>
			</div>
			...
			<div id="meet_us" class="scrollspy">
				<div class="inline-block">
					<h4><?php if ($SETTINGS->decoration == 2) echo '❤️'; ?> Γνωρίστε μας:</h4>
					<div class="divider"></div>
				</div>
				<div class="row">
					<?php 
						...
						foreach ($images as $key => $value) {
							if (!in_array(pathinfo($value, PATHINFO_EXTENSION), array('jpg','jpeg','png'))){
								unset($images[$key]);
							}
						}
